...
import { MetricsController } from '../src/modules/metrics/presentation/metrics.controller';
import { MetricsUseCases } from '../src/modules/metrics/application/metrics.usecases';
import { METRICS_REPOSITORY } from '../src/modules/metrics/application/metrics.repository';
import type { MetricGoal } from '../src/modules/metrics/domain/metrics';
